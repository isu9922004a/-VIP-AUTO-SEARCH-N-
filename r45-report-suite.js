/* R5.3.2.4.16-R4.5 research candidate: stock/market full-screen typography optimization. */
(function(){
'use strict';

const RELEASE=window.R45_RELEASE_LABEL||'石頭少爺 Agent V47 研究候選版｜R5.3.2.4.16-R4.5';
const FILE_VERSION=window.R45_FILE_VERSION||'V47_R5.3.2.4.16-R4.5_研究候選';
...
function safeName(value){
  ...
  return base.replace(/R5\.3\.2\.4\.13-R4\.4[^.\s]*/g,'R5.3.2.4.16-R4.5');
}
